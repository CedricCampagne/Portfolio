export const projects = [
  {
    ...
    image: "src/lib/assets/images/blablabook-3.webp",
  ...
  },
  {
    ...
    image: "src/lib/assets/images/cedric-bot-3.png",
  ...
  {
    title: "CoffeeStore",
    description: "CoffeeStore est un projet de reproduction d’un site vitrine pour une boutique de café. Développé avec Node.js et Express, il s’appuie sur PostgreSQL pour la gestion des données. Les vues sont rendues avec EJS, offrant une interface simple et dynamique. Ce projet illustre la mise en place d’une architecture web complète côté serveur et base de données.",
    image: "src/lib/assets/images/coffee-store-2.png",
